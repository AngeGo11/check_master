...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $authController->resetPassword($token, $newPassword, $confirmPassword);
...
<head>
    ...
    <title>CHECK MASTER - Réinitialisation du mot de passe</title>
...
<body class="h-full bg-mesh-gradient">
    ...
    <?php if (isset($_SESSION['error_message'])): ?>
        <div class="fixed top-4 right-4 z-50 bg-red-100 border-red-400 text-red-700 border px-6 py-4 rounded-lg shadow-lg animate-slide-in-right max-w-md">
            <div class="flex items-center">
                <i class="fas fa-exclamation-circle mr-3 text-lg"></i>
                <span class="font-medium"><?php echo $_SESSION['error_message']; ?></span>
    ...
    <?php if (isset($_SESSION['success_message'])): ?>
        <div class="fixed top-4 right-4 z-50 bg-green-100 border-green-400 text-green-700 border px-6 py-4 rounded-lg shadow-lg animate-slide-in-right max-w-md">
            <div class="flex items-center">
        ...
        <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24 relative">
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96 relative z-10">
                ...
                <div class="text-center animate-slide-up">
                    ...
                    <p class="text-lg font-semibold text-gray-700 mb-2">Réinitialisation du mot de passe</p>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                        <i class="fas fa-eye-slash toggle-password text-gray-400 cursor-pointer"></i>
                                    </div>
                                </div>
                            ...
                            <div>
                                <button type="submit" 
                                    ...
                                    <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                        <i class="fas fa-key text-white/80 group-hover:text-white transition-colors"></i>
                                    </span>
                ...
                <div class="relative h-full flex flex-col justify-center items-center text-white p-12">
                    ...
                    <div class="animate-float mb-8">
                        <div class="w-64 h-64 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center">
                            <div class="w-48 h-48 bg-white/20 rounded-full flex items-center justify-center">
                                <i class="fas fa-shield-alt text-8xl text-white/90"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center max-w-md animate-slide-in-right" style="animation-delay: 0.3s">
                        ...
                        <p class="text-lg text-white/90 mb-6">
                            Votre nouveau mot de passe sera sécurisé et protégé par notre système de chiffrement avancé.
                        </p>
                        ...
                        <div class="space-y-3 text-left">
                            <div class="flex items-center">
                                ...
                                <span class="text-white/90">Chiffrement SHA-256 sécurisé</span>
                            </div>
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mr-3">
                                    <i class="fas fa-check-circle text-sm"></i>
                                </div>
                                <span class="text-white/90">Validation en temps réel</span>
                            </div>
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mr-3">
                                    <i class="fas fa-user-shield text-sm"></i>
                                </div>
                                <span class="text-white/90">Accès immédiat après réinitialisation</span>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.querySelector('button[type="submit"]').addEventListener('click', function(e) {
            ...
            this.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Réinitialisation...';
            this.disabled = true;
