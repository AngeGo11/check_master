<!-- Modal de modification de l'étudiant -->
<div class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50" id="modify-student-modal">
    <div class="bg-white rounded-xl shadow-2xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto animate-bounce-in">
        <!-- En-tête de la modale -->
        <div class="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-secondary to-orange-500 text-white rounded-t-xl">
            ...
            <button class="text-white/80 hover:text-white transition-colors duration-200" id="close-modal-modify-btn">
                <i class="fas fa-times text-2xl"></i>
            </button>
        </div>

        <!-- Formulaire -->
        <form action="?page=etudiants&action=modify_process&id=<?php echo $etudiant_modify['etudiant']['num_etd']; ?>" method="POST" id="std-form" enctype="multipart/form-data" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               id="card" 
                               name="card" 
                               value="<?php echo htmlspecialchars($etudiant_modify['etudiant']['num_carte_etd']); ?>" 
                    ...
                    <div class="form-group">
                        <label for="niveau_etude" class="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               id="nom" 
                               name="nom" 
                               value="<?php echo htmlspecialchars($etudiant_modify['etudiant']['nom_etd']); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               id="prenoms" 
                               name="prenoms" 
                               value="<?php echo htmlspecialchars($etudiant_modify['etudiant']['prenom_etd']); ?>" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-colors duration-200"
                               required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" 
                               id="email" 
                               name="email" 
                               value="<?php echo htmlspecialchars($etudiant_modify['etudiant']['email_etd']); ?>" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-colors duration-200"
                               required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <input type="date" 
                               name="date" 
                               id="date" 
                               value="<?php echo $etudiant_modify['etudiant']['date_naissance_etd'] ? htmlspecialchars($etudiant_modify['etudiant']['date_naissance_etd']) : ''; ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const closeButtons = document.querySelectorAll('#close-modal-modify-btn, #close-modal-modify-btn-2');
    const modal = document.getElementById('modify-student-modal');
